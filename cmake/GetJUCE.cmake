...
set(GUITAR_JUCE_VERSION "8.0.4" CACHE STRING "JUCE version to fetch when no local copy is given")
...
elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../JUCE/CMakeLists.txt")
    ...
    message(STATUS "Fetching JUCE ${GUITAR_JUCE_VERSION} with FetchContent")

    include(FetchContent)
    FetchContent_Declare(JUCE
        GIT_REPOSITORY https://github.com/juce-framework/JUCE.git
        GIT_TAG        ${GUITAR_JUCE_VERSION}
        GIT_SHALLOW    TRUE
        GIT_PROGRESS   TRUE)
